...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(0, 26):
            j = (shift+i+26)%26
            ret[chr(i+65)] = chr(j+65)
            ret[chr(i+97)] = chr(j+97)
        return ret
...
class PlaintextMessage(Message):
    ...
    def get_encryption_dict(self):
        ...
        '''
        ret = {}
        for i in self.encryption_dict:
            ret[i] = self.encryption_dict[i]
        return ret
    ...
    def get_message_text_encrypted(self):
        ...
        '''
        ret = self.message_text_encrypted
        return ret
